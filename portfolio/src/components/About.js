  ...
  return (
    <div className="about">
      ...
      <div className='paragraphe'>
        ...
        <p>Durant le cours de ma vie, j'ai obtenue le diplômes du baccalauréat S.T.I Génie civil en juillet 2011,
          ensuite
          j'ai travailler cher carrefour en tant qu'hôte de caisse de juillet 2011 à Mars 2014. J'ai étais chez class'
          croûte de Mars 2013 à SEptembre 2015 en tant qu'assistant de responsable
          et ma dernières expèriences Proffessionnelles avant d'intégrer la formation de chez la web@cademie by epitech
          à étais a la poste en tant que facteur de Avril 2017 à Septembre 2019.
        </p>
        <h3>Hobbies</h3>
        <p>Je suis quelqu'un qui aime beaucoup le sport comme le football, la salle de fitness, la boxe, le tennis.
          J'aime voyager à travers les pays du monde, découvrir de nouveaux horizons et
          de cultures. Grand fan de jeux vidéo aussi, quand j'ai du temps libre je me l'accorde avec ma playstation4 et
          c'est partit pour jouer en ligne. ALLEZ AU CINÉMA, AU RESTAURANT, SORTIR EN SOIRÉE AVEC LES AMI(E)S ET LA
          FAMILLE.
